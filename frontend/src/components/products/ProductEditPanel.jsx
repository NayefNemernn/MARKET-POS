...
export default function ProductEditPanel({
  ...
  // Load sales stats when product opens
  useEffect(() => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingProduct.expiryDate)
        data.append("expiryDate", editingProduct.expiryDate);
  ...
  return (
    <AnimatePresence>
      {editingProduct && (
        ...
        >
          {/* Backdrop */}
          <div onClick={() => setEditingProduct(null)} className="absolute inset-0 bg-black/50 backdrop-blur-sm" />
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl max-h-[90vh] bg-white dark:bg-[#161616] rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-white/10"
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-white/8 shrink-0">
              <div className="flex items-center gap-3">
                {(editPreview || editingProduct.image) ? (
                  <img src={editPreview || editingProduct.image} className="w-9 h-9 rounded-xl object-cover border border-gray-200 dark:border-white/10" onError={e => e.target.src = "/placeholder.png"} />
                ) : (
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">{editingProduct.name}</p>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="grid grid-cols-2 gap-0 divide-x divide-gray-100 dark:divide-white/8">
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input type="number" min="0" step="0.01" value={editingProduct.cost || ""}
                        placeholder="0.00"
            ...
            {/* Footer */}
            <div className="px-6 py-4 border-t border-gray-100 dark:border-white/8 flex gap-3 shrink-0 bg-gray-50 dark:bg-[#111]">
              <button onClick={() => setEditingProduct(null)}
